const SeedRecipes = [
	{
		...
		timing: { prepHr: 0, prepMin: 5, cookHr: 8, cookMin: 0 },
		ingredients: [
			{
				ingredient: 'pork shoulder butt roast',
				qty: '3',
				measure: 'lb',
				description: '',
			},
	...
	},
	{
		...
		timing: { prepHr: 0, prepMin: 10, cookHr: 0, cookMin: 30 },
		ingredients: [
			{
				ingredient: 'chorizo',
				qty: '4',
				measure: 'oz',
				description: 'Spanish dry-cured chorizo preferred',
			},
			{
			...
			},
			{
				...
				qty: '1',
				measure: 'c',
				description: 'no need to defrost',
			},
			...
			{ ingredient: 'half and half', qty: '1', measure: 'c', description: '' },
			{
				...
				qty: '2',
				measure: 'tsp',
				description: 'spanish smoked paprika preferred',
			},
			{
	...
	},
	{
		...
		timing: { prepHr: 0, prepMin: 15, cookHr: 1, cookMin: 10 },
		ingredients: [
			...
			{
				ingredient: 'sliced white cheddar cheese',
				qty: '8',
				measure: '',
				description: '',
			},
	...
	},
	{
		...
		timing: { prepHr: 0, prepMin: 25, cookHr: 0, cookMin: 10 },
		ingredients: [
			{
			...
			{ ingredient: 'butter', qty: '2', measure: 'tbsp', description: '' },
			{
				ingredient: 'wing sauce',
				qty: '',
				measure: '',
				description: 'enough to cover amount of wings',
			},
			{
				ingredient: 'canola oil',
				qty: '',
				measure: '',
				description: 'enough to fully submerge wings in',
			},
		],
		instructions: [
